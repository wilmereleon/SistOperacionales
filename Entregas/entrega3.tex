...
\textbf{Funcionamiento:} Los procesos se atienden en orden estricto de llegada (cola FIFO). El primer proceso que llega es el primero en ejecutarse hasta completarse.
...
\textbf{Ventajas:} Tiempo de espera promedio óptimo (demostrable matemáticamente). Mejora el throughput en entornos batch.
...
\textbf{Casos de uso:} Sistemas operativos de tiempo compartido (time-sharing), entornos multiusuario interactivos, servidores web con múltiples conexiones concurrentes, sistemas donde la equidad es crítica.
